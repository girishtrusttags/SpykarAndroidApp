...
class ScanActivity : BaseActivity(),BarcodeReader.BarcodeReaderListener {
...
//    val ACTIVITY_REQUEST_FOR_SCANNING = 1
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgClear.setOnClickListener {
            PreferenceConnector.writeInteger(this@ScanActivity, PreferenceConnector.MAPPED_CODE, 0)
            Toast.makeText(
                    this@ScanActivity, "Session cleared",
                    Toast.LENGTH_SHORT
            ).show()
...
//                    listenerResponse.onError(e.message.toString())
    ...
    private fun sessionOut(){
        Toast.makeText(
                this@ScanActivity,"Invalid Token or Key",
                Toast.LENGTH_SHORT
        ).show()
