...
public class ScannerOverlay extends ViewGroup {
    ...
    public ScannerOverlay(Context context, AttributeSet attrs, int defStyle) {
        ...
        rectWidth = (int) context.getResources().getDimension(R.dimen._109sdp);
        rectHeight = (int) context.getResources().getDimension(R.dimen._109sdp);

        topPadding = (int) context.getResources().getDimension(R.dimen._109sdp);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rect = new RectF(left, top - 200, dpToPx(rectWidth) + left, dpToPx(rectHeight) + (top - 200));
        ...
        canvas.drawLine(left, endY - 200, left + dpToPx(rectWidth), endY - 200, line);
        invalidate();
    }
}